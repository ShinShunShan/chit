"""Q40: Image security over an unsecured network (standalone AES-GCM).
Encrypt image bytes into JSON bundle and decrypt back.
Usage:
...
if __name__=='__main__':
    if len(sys.argv)<4: print('Usage: python q40.py <encrypt|decrypt> <in> <out>')
    else:
        a=sys.argv[1]
