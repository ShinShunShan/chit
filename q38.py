"""Q38: Custom encryption/decryption algorithm (standalone, educational).
Scheme: XOR with repeating key, then rotate each byte left by 1 bit.
Usage:
  python q38.py encrypt "Hello" key
  python q38.py decrypt <hex> key
"""
import sys
...
if __name__=='__main__':
    if len(sys.argv)<3:
        print('Usage encrypt: python q38.py encrypt <message> <key>')
        print('Usage decrypt: python q38.py decrypt <hex> <key>')
    else:
        a=sys.argv[1]
